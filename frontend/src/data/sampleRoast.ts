...
const priyaSharma: SampleResume = {
  roastData: {
    ...
    issues: [
      {
        quoted_text:
          "Passionate software developer with excellent problem-solving skills",
        category: "buzzword",
        badge_label: "LINKEDIN BIO VIBES",
        roast:
          '"Passionate" aur "excellent" — ye toh LinkedIn bio se utha li lagti hai bhai 🤡 recruiter ko code dikha, feelings nahi.',
      ...
      {
        quoted_text:
          "Worked on a college project using React, Node.js, MongoDB, AWS, Docker, Redis",
        category: "buzzword",
        badge_label: "TECH STACK STUFFING",
        roast:
          'Itne saare tools ek "college project" mein? 👀 Har ek ka actual use batao — warna lagta hai ye tech stack Wikipedia se copy kiya hai.',
      ...
      },
      {
        ...
        roast:
          "Improved kaise? Kitna? 5ms ya 500ms? Bina number ke ye line sirf poem hai bhai, achievement nahi 📝",
      ...
      {
        quoted_text:
          "Developed a machine learning model for sentiment analysis",
        category: "no-metrics",
        badge_label: "ACCURACY KAHAN HAI",
        roast:
          '"Developed a model" — accuracy kitni thi bhai? Recruiter ko result chahiye, method nahi 😬',
      ...
      },
      {
        ...
        roast:
          '"Participated in various" — bhai participation trophy nahi chahiye, result batao 🏆 jeet kuch tha ya sirf gaye the?',
      ...
      },
      {
        ...
        roast:
          "Bhai biodata thodi hai 😅 cooking aur travelling se SWE internship nahi milti, ye space GitHub links mein use karo.",
  ...
  resumeInfo: {
    ...
    bullet1Text:
      "Passionate software developer with excellent problem-solving skills and strong communication.",
    bullet1Annotated:
      "Passionate software developer with excellent problem-solving skills",
    bullet1Tag: "LINKEDIN BIO COPY-PASTE",
    bullet2Text:
      "Worked on a college project using React, Node.js, MongoDB, AWS, Docker, Redis, and GraphQL.",
    bullet2Annotated: "React, Node.js, MongoDB, AWS, Docker, Redis",
    bullet2Tag: "TECH STACK STUFFING",
    bullet3Text:
      "Improved the performance of the application and participated in various hackathons.",
...
const amanVerma: SampleResume = {
  roastData: {
    ...
    issues: [
      {
        quoted_text:
          "Spearheaded synergistic cross-functional initiatives to drive holistic brand value",
        category: "buzzword",
        badge_label: "JARGON OVERDOSE",
        roast:
          'Itna bhari corporate jargon padh ke recruiter behosh ho jayega bhai 😵 "spearheaded synergistic" — real life mein koi aisa nahi bolta.',
      ...
      {
        quoted_text:
          "Managed end-to-end campaign lifecycle and stakeholder communications",
        category: "no-metrics",
        badge_label: "DATA GHAYAB HAI",
        roast:
          '"End-to-end" sun ke lagta hai kuch bada kiya, par bina data ke ye sirf English hai, achievement nahi 🗣️',
      ...
      {
        quoted_text:
          "Demonstrated exceptional leadership and strategic thinking",
        category: "buzzword",
        badge_label: "PROOF DE DO",
        roast:
          '"Exceptional leadership" — bhai ye award nahi tha, toh proof kahan hai? Recruiter aankh band kar ke nahi manega 🙃',
      ...
      },
      {
        ...
        roast:
          'Har resume mein "collaborated with stakeholders" aata hai bhai, tu bata kaun nahi karta yaar 😂 specific karo.',
      ...
      },
      {
        ...
        roast:
          '"Data-driven insights" sun ke lagta hai kuch dekha, but koi number nahi — seedha bolo kya dekha aur kya change kiya 📉',
      ...
      {
        quoted_text:
          "DECLARATION: I hereby declare that all information provided is true to the best of my knowledge.",
        category: "irrelevant",
        badge_label: "OUT OF PLACE HAI",
        roast:
          "Bhai 2005 ka declaration kyu daal rakha hai? ✋ Ye line 15 saal pehle hi expire ho gayi, delete karo.",
  ...
  resumeInfo: {
    ...
    bullet2Tag: "NUMBER GHAYAB HAI",
    bullet3Text:
      "Demonstrated exceptional leadership and strategic thinking across all verticals.",
    ...
    issues: [
      {
        ...
        roast:
          "This objective sentence is copied and pasted on every second resume 💀 You blend in with 50,000 other applicants before anyone reads bullet two.",
      ...
      },
      {
        ...
        roast:
          '"Handling relationships" — did you get coffee together, or did you actually close revenue? 😩 Give recruiters a number.',
      ...
      },
      {
        ...
        roast:
          "Every human on earth claims to be a team player 🙃 Tell us what the team actually accomplished under your watch.",
      ...
      },
      {
        ...
        roast:
          "Nobody advertises themselves as lazy and unmotivated 🙃 This is default filler taking up prime page real estate.",
      ...
      },
      {
        ...
        roast:
          'What does "assisted in" mean? Did you generate the pipeline or just applaud in the all-hands? 👀',
      ...
      },
      {
        ...
        roast:
          'Listing "MS Office" in 2026 is like listing "I breathe oxygen" 🫠 That is not a competitive skill, that is basic computer literacy.',
...
const davidChen: SampleResume = {
  roastData: {
    ...
    band: "weak",
    one_line_verdict:
      "Claimed full-stack mastery without a single link to prove it 😭",
    total_issues: 6,
    is_truncated: true,
    was_document_truncated: false,
    issues: [
      {
        quoted_text:
          "Passionate software engineer with exceptional problem-solving skills",
        category: "buzzword",
        badge_label: "LINKEDIN CLICHE",
        roast:
          '"Passionate" and "exceptional" sound like an inspirational LinkedIn quote 🤡 Show the recruiter code, not emotional adjectives.',
      ...
      {
        quoted_text:
          "Worked on a project using React, Node.js, MongoDB, AWS, Docker, Redis",
        category: "buzzword",
        badge_label: "TOOL STACK OVERFLOW",
        roast:
          "All those technologies crammed into one student project? 👀 Explain your role, or this looks like a copy-pasted Wikipedia tech stack.",
      ...
      },
      {
        ...
        roast:
          "Improved it by what? 5 milliseconds or 500%? Without data, this claim is pure fiction 📝",
      ...
      },
      {
        ...
        roast:
          '"Developed a model" — what was the test accuracy? Recruiters evaluate outcomes, not methods 😬',
      ...
      },
      {
        ...
        roast:
          '"Participated in various" sounds like a participation ribbon 🏆 State your actual standing or podium finish.',
      ...
      },
      {
        ...
        roast:
          "This isn’t a dating profile 😅 Culinary skills do not help your pull requests get merged. Reclaim this space for GitHub project links.",
  ...
  resumeInfo: {
    ...
    bullet1Text:
      "Passionate software engineer with exceptional problem-solving skills and full-stack expertise.",
    bullet1Annotated: "exceptional problem-solving skills",
    bullet1Tag: "LINKEDIN CLICHE",
    bullet2Text:
      "Worked on a project using React, Node.js, MongoDB, AWS, Docker, and Redis to improve performance.",
    bullet2Annotated: "improve performance",
    bullet2Tag: "ZERO METRICS",
    bullet3Text:
      "Participated in various hackathons; hobbies include cooking and travelling.",
...
const sarahJenkins: SampleResume = {
  roastData: {
    ...
    band: "weak",
    one_line_verdict:
      "High-octane buzzwords, zero evidence of actual business impact 🤖",
    total_issues: 6,
    is_truncated: true,
    was_document_truncated: false,
    issues: [
      {
        ...
        roast:
          '"Spearheaded synergistic initiatives" is corporate word-salad at maximum velocity 🥗 Tell recruiters what you actually built.',
      ...
      },
      {
        ...
        roast:
          "A campaign with no budget, no conversion rate, and no revenue is just a hobby 📉 Where are the numbers?",
      ...
      },
      {
        ...
        roast:
          'Self-proclaiming "exceptional leadership" is bold when you have zero team retention metrics to back it up 🙃',
      ...
      },
      {
        ...
        roast:
          "Everyone collaborates with stakeholders. Unless you work on a desert island, this adds zero differentiation 😂",
      ...
      },
      {
        ...
        roast:
          '"Data-driven insights" sounds impressive until the interviewer asks which data and what happened next 📉',
      ...
      },
      {
        ...
        roast:
          "Declarations and legal disclaimers retired in 2005 ✋ Modern tech recruiters consider this a red flag for template bloat.",
...
export const HINGLISH_SAMPLE_RESUMES: SampleResume[] = [
  rohanMehta,
  priyaSharma,
  amanVerma,
];
export const ENGLISH_SAMPLE_RESUMES: SampleResume[] = [
  alexMorgan,
  davidChen,
  sarahJenkins,
];
...
export function getDailyRotationIndex(
  resumes: SampleResume[] = SAMPLE_RESUMES,
): number {
  const now = new Date();
