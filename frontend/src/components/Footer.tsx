      ...
      <div className="max-w-[1020px] mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center justify-between">
          ...
          <div className="md:col-span-5 text-center md:text-left space-y-3">
            <Link
              to="/"
              className="inline-block font-display text-lg sm:text-xl tracking-tight text-paper"
            >
              RESUME<span className="text-stamp">ROAST</span>
              <span className="text-amber-400 font-mono text-[10px] ml-1.5">
                // 100% RAW
              </span>
            </Link>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-3.5 text-center sm:text-left">
                  <div className="relative shrink-0">
                    ...
                    <span
                      className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full bg-emerald-500 border-2 border-[#171410]"
                      title="Active"
                    />
                  </div>
                  <div>
                    <div className="flex items-center gap-2 justify-center sm:justify-start">
                      <span className="font-display text-base text-paper tracking-tight">
                        Devesh Singh
                      </span>
                    ...
                    <p className="font-mono text-xs text-tan-dim mt-0.5">
                      {isHinglish
                        ? "Crafted with code, coffee & zero fluff"
                        : "Crafted with code, coffee & zero fluff"}
                    </p>
                  </div>
                </div>
        ...
        <div className="pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <nav
            className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 font-mono text-xs text-tan-dim"
          ...
          >
            ...
            >
              <span>💡</span>
              <span>
                {isHinglish ? "Suggest something" : "Suggest something"}
              </span>
            </button>
            <Link
              to="/stats"
          ...
          <div className="font-mono text-xs text-tan-dim">
            ...
            {isHinglish ? "Haq se banaya gaya." : "All rights reserved."}
          </div>
        </div>
      </div>
    </footer>
